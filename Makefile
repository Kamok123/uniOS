...
# Files
# Files
KERNEL_SRC = kernel/kernel.cpp kernel/gdt.cpp kernel/idt.cpp kernel/pic.cpp kernel/keyboard.cpp kernel/timer.cpp kernel/pmm.cpp kernel/vmm.cpp kernel/heap.cpp kernel/scheduler.cpp kernel/unifs.cpp kernel/shell.cpp kernel/syscall.cpp
